...
async function addMember(req, res) {
  try {
    ...
    if (already.rows.length > 0) {
      return res.status(409).json({message: 'This student is already a member of the group'});
    }
...
module.exports = {createGroup, myGroups, listAllGroups, getGroup, addMember, removeMember};
